...
- (void)depthFirstSearchWithURL: (NSString *)urlString
    ...
    [_parsers addObject:htmlParser];
    
//    [htmlParser searchWithURL:urlString completionHandler:^(NSArray *hrefArray, NSArray *imgArray, NSError *error) {
//        if (error) {
//            self.recur_count--;
//            handler(error);
//        } else {
